(ns marketentry.marketentryllm
  ...
  the ARE public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "has-ae-entity?=" (:has-ae-entity? e)
                        " trade-license-verified?=" (:trade-license-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-ae-entity? e))
                              (:has-ae-entity? e))
                          (or (not (:requires-trade-license? e))
                              (:trade-license-verified? e)))
                   0.9 0.3)}))
