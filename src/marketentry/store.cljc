(ns marketentry.store
  "SSoT for the ARE market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems AE" :portal "Federal e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ae-entity? true :has-ae-entity? true
             :requires-trade-license? true :trade-license-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ARE" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Federal e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ae-entity? true :has-ae-entity? true
             :requires-trade-license? true :trade-license-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Federal e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ARE" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Federal e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ae-entity? true :has-ae-entity? false
             :requires-trade-license? true :trade-license-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ARE" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Federal e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ae-entity? true :has-ae-entity? true
             :requires-trade-license? true :trade-license-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ARE" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Federal e-procurement"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ae-entity? has-ae-entity?
                               requires-trade-license? trade-license-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ae-entity?)  (assoc :engagement/requires-ae-entity? requires-ae-entity?)
    (some? has-ae-entity?)       (assoc :engagement/has-ae-entity? has-ae-entity?)
    (some? requires-trade-license?)    (assoc :engagement/requires-trade-license? requires-trade-license?)
    (some? trade-license-verified?)    (assoc :engagement/trade-license-verified? trade-license-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ae-entity? :engagement/has-ae-entity?
   :engagement/requires-trade-license? :engagement/trade-license-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ae-entity? (boolean (:engagement/requires-ae-entity? m))
     :has-ae-entity? (boolean (:engagement/has-ae-entity? m))
     :requires-trade-license? (boolean (:engagement/requires-trade-license? m))
     :trade-license-verified? (boolean (:engagement/trade-license-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-are"})
